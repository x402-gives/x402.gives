        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Card className="mb-12">
            ...
            <CardContent className="space-y-6">
              ...
              <div id="demo" className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <h4 className="font-semibold mb-3">Quick Demo:</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  Click the input fields above, enter your information, and the system will
                  automatically redirect to the Builder page where you can configure detailed
                  donation options.
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-500">
                  💡 Tip: If you are a GitHub project maintainer, we recommend using the
                  configuration file approach (see "Advanced Usage" below).
                </p>
              </div>
            </CardContent>
          </Card>
